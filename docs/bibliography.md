...
This page centralizes the source list for the TrayGuard documentation. In-text
citations throughout `docs/` should link back to the relevant entry here.

## Sources

<a id="agostini-and-nosella-2020"></a>
...
<a id="schlachter-et-al-2020"></a>
### Schlachter et al., 2020
