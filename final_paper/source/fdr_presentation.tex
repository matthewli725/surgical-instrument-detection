...
% ======================================================================
%  SECTION 2: The Problem is Deeper Than a Camera Can See
% ======================================================================
\section{The Problem is Deeper Than a Camera Can See}
\sectiondivider{The Problem is Deeper Than a Camera Can See}
...
\begin{frame}{Real Instruments: The Model Learned Position, Not Shape}
  \begin{columns}[T]
    ...
    \incfig[\textwidth]{figures/confusion_matrix_normalized.png}
    \column{0.48\textwidth}
    \centering
    \textbf{Prediction example}\\
    \incfig[\textwidth]{figures/val_batch0_pred.jpg}
  \end{columns}
  \vspace{0.2cm}
  \centering
  \small
...
\begin{frame}{Printed Cards: How It Works Physically}
  \begin{columns}[T]
    ...
    \incfig[\textwidth]{figures/card_front_placeholder.pdf}
    \column{0.48\textwidth}
    \centering
    \textbf{Back (study)}\\
    \incfig[\textwidth]{figures/card_back_placeholder.pdf}
  \end{columns}
  \vspace{0.3cm}
  \begin{block}{}
    \centering
...
\begin{frame}{The Learning Loop (7 Steps)}
  ...
  \end{block}
  \note{This is the full learner loop. Each step has a specific evidence-based role. The pre-test and post-test use parallel variants — same instrument families, different specific items — so the learner can't memorize the exact layout. Study cards are prompt-before-reveal: the learner commits to an answer before seeing it, which is retrieval practice, not passive review. The practice sort gives immediate error-category feedback — "you missed the Kelly clamp," "you selected curved instead of straight Mayo." The whole loop takes about 45 to 60 minutes for a first module.}
\end{frame}
