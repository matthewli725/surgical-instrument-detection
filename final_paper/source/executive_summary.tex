...
TrayGuard targets the training gap among the six root causes. If novices can
reduce simulated tray-assembly errors by at least 20~percentage points after
retrieval-centered practice with local tray content, the system provides a
replicable preparation step before supervised clinical training --- reducing
clinical supervisor burden and improving first-pass assembly quality.

\paragraph{Negative externalities.}
Learner scores from a simulated tool could be misused as employment screens or
competency determinations. Overreliance on simulation scores could lead
programs to reduce supervised practice time. Better-resourced sites may build
richer modules, creating unequal training quality. Controls include hashed
participant IDs, explicit labeling of results as simulated practice evidence,
open module formats, and a design constraint that TrayGuard prepares for ---
but does not replace --- supervised practice.
...
deployment-grade recognition to measurable novice learning on a simulated local
...
validated preparation tool within the SPD training ecosystem.
